...
public class ProcessDataTab {
    ...
    public void setDocType(String docType) {
        ...
        if (!this.createProcessForm.getProcesses().isEmpty()) {
            this.createProcessForm.getProcesses().get(0).getWorkpiece().getLogicalStructureRoot().setType(this.docType);
            if (this.docType.isEmpty()) {
                ...
                ProcessFieldedMetadata metadata = this.createProcessForm.getProcessMetadataTab()
                        .initializeProcessDetails(this.createProcessForm.getProcesses().get(0).getWorkpiece().getLogicalStructureRoot());
