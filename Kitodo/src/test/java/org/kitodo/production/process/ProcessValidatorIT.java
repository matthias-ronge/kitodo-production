...
public class ProcessValidatorIT {
    ...
    private List<ProcessDetail> createProcessDetailsList() throws IOException {
        ...
        workpiece.getLogicalStructureRoot().setType("Monograph");
        ...
        ProcessFieldedMetadata processDetails = new ProcessFieldedMetadata(workpiece.getLogicalStructureRoot(), monograph);
