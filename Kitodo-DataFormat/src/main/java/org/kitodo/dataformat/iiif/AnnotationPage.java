...
/**
 * A collection of annotations. The requirement of annotation pages necessitates
 * a certain grouping of the individual annotation elements on a canvas.
 * {@link Annotation}s are collected together in annotation pages.
 *
 * <P>
 * This class implements {@code InternalLink} because it can internally be
 * referenced.
 */
public class AnnotationPage implements InternalLink {
    ...
    /**
     * &#x1F511; Returns the identifier. A URI that identifies the annotation page.
     * 
    ...
    /**
     * &#x1F511; Sets the identifier. Annotation pages must have an id. The URI may
     * be the URI of the embedding resource with a unique fragment on the end.
     * 
    ...
    /**
     * &#x1F511; Sets the items. An annotation page is recommended to have items.
     * 
