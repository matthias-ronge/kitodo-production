...
/**
 * Content element on a canvas. Annotations contain the individual pieces of
 * content that make up the entire page.
 *
 * <P>
 * Every element made available on a page is an annotation. The content resource
 * is linked in the body of the annotation. The term “annotation” originates
 * from the Web Annotation Data Model.
 *
 * <P>
 * This class implements {@code InternalLink} because it can internally be
 * referenced.
 * 
 * @see http://w3.org/TR/annotation-model/
 */
public class Annotation implements InternalLink {
    ...
    /**
     * &#x1F511; Returns the motivation. Indicates whether the content should be
     * rendered.
     * 
     ...
     * &#x1F511; Sets the motivation.
     * 
     * @param motivation motivation to set. Must not be {@code null}.
     */
    public void setMotivation(Motivation motivation) {
        assert motivation != null : "motivation must not be null";

        this.motivation = motivation;
    }

    /**
     * &#x1F511; Returns the content reference. The content reference of the canvas.
     * 
     ...
     * 
     * @param body content reference to set. Must not be {@code null}.
     */
    ...
    /**
     * &#x1F511; Sets the identifier. Annotations must have an id. The URI may be
     * the URI of the embedding resource with a unique fragment on the end.
     * 
    ...
    /**
     * Returns the time mode. A mode for rendering of time-based media.
     * 
     ...
     * Sets the time mode.
     * 
     * @param timeMode time mode to set. Must not be {@code null}.
     */
    public void setTimeMode(TimeMode timeMode) {
        assert timeMode != null : "timeMode must not be null";
