...
/**
 * &#x1F511; An object of intellectual work. It is the basis for representing a
 * process in IIIF.
 *
 * <P>
 ...
 * includes descriptive, rights and linking information for the object.
 *
 * <P>
 * This class implements {@code CollectionOrManifest} because it must be mixable
 * with collections in the {@code items} list of {@code Collection}s. This class
 * implements {@code InternalLink} because it can internally be referenced.
 */
public class Manifest implements CollectionOrManifest, InternalLink {
    ...
    /**
     * &#x1F511; Sets the name. A manifest must have a label.
     * 
    ...
    /**
     * &#x1F511; Sets the metadata. A manifest is recommended to have metadata.
     * 
    ...
    /**
     * &#x1F511; Sets the summary. A manifest is recommended to have a summary.
     * 
    ...
    /**
     * &#x1F511; Sets the provider. A manifest is recommended to have a provider.
     * 
    ...
    /**
     * &#x1F511; Sets the thumbnail. A manifest is recommended to have a thumbnail.
     * 
    ...
    /**
     * &#x1F511; Returns the identifier. A URI that identifies the manifest.
     * 
    ...
    /**
     * &#x1F511; Sets the identifier. A manifest must have an id.
     * 
    ...
    /**
     * &#x1F511; Sets the items. A manifest must have items.
     * 
     ...
     * &#x1F511; Sets the structures.
     * 
     * @param structures structures to set. Must not be {@code null}.
     */
    public void setStructures(List<Range> structures) {
        assert structures != null : "structures must not be null";
